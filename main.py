...
transformer = XGBoostTransformer(users, items, train_user_item, uidx, iidx)
X1, Y1, X1c, Y1c, feature_len = transformer.get_feature_vectors(users, items, test_user_item)
# print(X1c[0:100])

transformerfm = FactorizationMachineTransformer(users, items, train_user_item, uidx, iidx)
